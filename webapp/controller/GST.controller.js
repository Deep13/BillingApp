sap.ui.define(
    ...
    function (Controller, JSONModel, Dialog, Button, List, StandardListItem, mobileLibrary) {
        ...
        return Controller.extend("Billing.Billing.controller.GST", {
                ...
                $.ajax({
                    ...
                    success: function (dataClient) {
                        try {
                            ...
                            that.getView().byId('tableHeader').setText(`GST (${aData.length})`)
                ...
                if (!this.oDefaultDialog) {
                    ...
                    this.oDefaultDialog = new Dialog({
                        ...
                        content: [new sap.m.VBox({
                            items: [new sap.m.Label({ text: 'GST Value' }), new sap.m.Input({ id: 'item' })]
            ...
            saveItem: function () {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {
                        method: "insertGstEntry",
                        data: JSON.stringify({ item: 'GST', value: item }),
                    },
                    success: function (dataClient) {
            ...
            onPressEdit: function (oEvent) {
                ...
                if (!that.oDefaultDialog) {
                    ...
                    that.oDefaultDialog = new Dialog({
                        title: "Edit GST",
                        content: [new sap.m.VBox({
                            items: [new sap.m.Label({ text: 'GST value' }), new sap.m.Input({ id: 'item', value: selectData.value })]
                        }).addStyleClass("sapUiMediumMargin")],
                        beginButton: new Button({
                            type: ButtonType.Emphasized,
                            text: "Save",
