sap.ui.define(
    ...
    function (Controller, JSONModel, Dialog, Button, List, StandardListItem, mobileLibrary) {
        ...
        return Controller.extend("Billing.Billing.controller.Ornament", {
                ...
                $.ajax({
                    ...
                    success: function (dataClient) {
                        try {
                            ...
                            that.getView().byId('tableHeader').setText(`Ornaments (${aData.length})`)
                                ...
                                that.oDefaultDialog = new Dialog({
                                    ...
                                    content: [new sap.m.VBox({
                                        items: [new sap.m.Label({ text: 'Ornament Type' }), , new sap.m.Select({
                                            ...
                                            width: '100%',
                                            items: selectItems
                                        }), new sap.m.Label({ text: 'Item' }), new sap.m.Input({ id: 'item' }), new sap.m.Label({ text: 'Suffix' }), new sap.m.Input({ id: 'suffix' })]
            ...
            saveItem: function () {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        data: JSON.stringify({ id: null, item: item, otid: omtypeid, ottitle: omtypetext, suffix: suffix }),
                    },
                    success: function (dataClient) {
            ...
            editItem: function (selectData) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        data: JSON.stringify({ id: selectData.id, item: item, otid: omtypeid, ottitle: omtypetext, suffix: suffix }),
                    },
                    success: function (dataClient) {
                        console.log(dataClient);
                        sap.ui.core.BusyIndicator.hide();
                        ...
                        try {
                            ...
                            if (!that.oDefaultDialog) {
                                ...
                                that.oDefaultDialog = new Dialog({
                                    ...
                                    content: [new sap.m.VBox({
                                        items: [new sap.m.Label({ text: 'Ornament Type' }), , new sap.m.Select({
                                            selectedKey: selectData.otid,
                                            id: 'omtype',
                                            width: '100%',
                                            items: selectItems
                                        }), new sap.m.Label({ text: 'Item' }), new sap.m.Input({ id: 'item', value: selectData.item }), new sap.m.Label({ text: 'Suffix' }), new sap.m.Input({ id: 'suffix', value: selectData.suffix })]
                                    }).addStyleClass("sapUiMediumMargin")],
                                    beginButton: new Button({
                                        type: ButtonType.Emphasized,
                                        text: "Save",
