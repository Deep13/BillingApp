sap.ui.define(
    ...
    function (Controller, JSONModel, Dialog, Button, List, StandardListItem, mobileLibrary) {
        ...
        return Controller.extend("Billing.Billing.controller.HSN", {
                ...
                $.ajax({
                    ...
                    success: function (dataClient) {
                        try {
                            ...
                            that.getView().byId('tableHeader').setText(`HSN (${aData.length})`)
                                ...
                                that.oDefaultDialog = new Dialog({
                                    ...
                                    content: [new sap.m.VBox({
                                        items: [new sap.m.Label({ text: 'Ornament Type' }), , new sap.m.Select({
                                            ...
                                            width: '100%',
                                            items: selectItems
                                        }), new sap.m.Label({ text: 'HSN' }), new sap.m.Input({ id: 'item' })]
